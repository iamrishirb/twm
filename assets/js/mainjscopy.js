...
function PopulateMenu(rates,staked, unstakeasset, user, balance) {
  ...
  console.log(user.stakePower);
  document.getElementById('stakepwr').innerHTML=user.stakePower + " PER HOUR";
  document.getElementById('stakedcount').innerHTML=staked.length;
  document.getElementById('stakedcount').innerHTML=staked.length;
  document.getElementById('unclaimed').innerHTML=user.unclaimed_amount;
