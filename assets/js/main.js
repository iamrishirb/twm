...
var collection = 'twmwaxcomics';
var switchtoshop = false;
var canclick = false;
var mainDiv = document.getElementById("maindiv");
var staking_a = document.getElementById("staking_a");
var t= 0;
async function main() {
...
async function GetBalance() {
  ...
  console.log(balance);
  var blc=document.getElementById("rbitbalance");
  blc.innerHTML=": "+balance+" RBIT";
  return balance;
...
function PopulateMenu(rates,staked, unstakeasset, user, balance) {
  ...
  document.getElementById('stakepwr').innerHTML=": "+user.stakePower + " PER DAY";
  document.getElementById('stakedcount').innerHTML=": "+staked.length;
  staking_a.style.visibility="visible";
